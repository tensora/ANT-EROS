function minimal_multi_screen_viewer_5x_EROS_OUT_COLOR_PADDING_DROP_v2_TUNER(erosFrames_double,fps_stat,ePerFrameList_in,micro,x_data,y_data,pol_data,t_data,retinaRes,path_reconstructed,path_canny,...
...
hTuneEROS = uicontrol('Style','pushbutton','Parent',hFig,'Units','normalized', ...
    'Position',[0.01 0.3 0.035 0.02], ...
    'String','Tune EROS', ...
    'Callback',@(src,~) tuneEROSCallback(hFig));
...
function tuneEROSCallback(figHandle)
