function frame = EROS_all_double_set_add_clipAny_limit5(frame,x,y,kEROS,gGAUSS,hGAUSS,kGAUSS,r0,sGAUSS,setEvent,kEVENT,setEventTilt,mEVENT,eventType,clipLevel)
    ...
    for i = 1:eNr
        ...
        frame(wymin:wymax, wxmin:wxmax) = min(newRegion,clipLevel);
