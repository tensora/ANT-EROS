 ...
 *
 * EROS_all_double_set_add_clipAny_limit5.c
 *
...
/* Include files */
#include "EROS_all_double_set_add_clipAny_limit5.h"
#include "EROS_all_double_set_add_clipAny_limit5_data.h"
#include "EROS_all_double_set_add_clipAny_limit5_emxutil.h"
...
static emlrtRSInfo emlrtRSI = {
    98,                                       /* lineNo */
    "EROS_all_double_set_add_clipAny_limit5", /* fcnName */
    "G:\\KTH\\KTH exjobb 2025 - Local\\EROS GUI\\04 "
    "spatial_descriptor\\EROS_all_double_set_add_clipAny_limit5.m" /* pathName
                                                                    */
};
...
static emlrtECInfo emlrtECI = {
    ...
    106,                                      /* lineNo */
    9,                                        /* colNo */
    "EROS_all_double_set_add_clipAny_limit5", /* fName */
    "G:\\KTH\\KTH exjobb 2025 - Local\\EROS GUI\\04 "
    "spatial_descriptor\\EROS_all_double_set_add_clipAny_limit5.m" /* pName */
};
...
void EROS_all_double_set_add_clipAny_limit5(
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if ((b_loop_ub == i9) && (c_loop_ub == i10)) {
      ...
      for (xi = 0; xi < c_loop_ub; xi++) {
        for (yi = 0; yi < b_loop_ub; yi++) {
          ...
          r1[yi + b_r->size[0] * xi] = muDoubleScalarMin(r, clipLevel);
        }
      }
    } else {
      st.site = &h_emlrtRSI;
      binary_expand_op(&st, b_r, frame, i6, loop_ub, i7, i8, decayKernel, i3,
                       i4, i5, b_index, clipLevel);
      r1 = b_r->data;
    }
    loop_ub = i1 - i11;
    iv1[0] = loop_ub;
    ...
    if (q == 1) {
      ...
      frame_data[e_old_tmp + frame->size[0] * b_e_old_tmp] =
          muDoubleScalarMin(setEvent, clipLevel);
      ...
      frame_data[e_old_tmp + frame->size[0] * b_e_old_tmp] =
          muDoubleScalarMin(e_old + setEvent, clipLevel);
    }
    /*   if i == 100000 */
    /*       ibreak = i; */
    /*  end */
...
/* End of code generation (EROS_all_double_set_add_clipAny_limit5.c) */
