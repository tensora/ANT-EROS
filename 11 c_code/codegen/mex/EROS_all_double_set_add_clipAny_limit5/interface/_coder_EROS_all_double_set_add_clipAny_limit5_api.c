 ...
 *
 * _coder_EROS_all_double_set_add_clipAny_limit5_api.c
 *
 * Code generation for function
 * '_coder_EROS_all_double_set_add_clipAny_limit5_api'
 *
 */
...
static emlrtRTEInfo c_emlrtRTEI = {
    1,                                                   /* lineNo */
    1,                                                   /* colNo */
    "_coder_EROS_all_double_set_add_clipAny_limit5_api", /* fName */
    ""                                                   /* pName */
};
...
void c_EROS_all_double_set_add_clipA(const mxArray *const prhs[15],
                                     const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
  ...
  clipLevel = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[14]), "clipLevel");
  /* Invoke the target function */
  EROS_all_double_set_add_clipAny_limit5(
      &st, frame, x, y, kEROS, gGAUSS, hGAUSS, kGAUSS, r0, sGAUSS, setEvent,
      kEVENT, setEventTilt, mEVENT, eventType, clipLevel);
...
/* End of code generation (_coder_EROS_all_double_set_add_clipAny_limit5_api.c)
 */
