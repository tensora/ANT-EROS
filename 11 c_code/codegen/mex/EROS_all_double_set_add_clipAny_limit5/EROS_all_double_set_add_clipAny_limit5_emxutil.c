 ...
 *
 * EROS_all_double_set_add_clipAny_limit5_emxutil.c
 *
                              ...
                              int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtMallocMex((uint32_T)newCapacity * sizeof(char_T));
    if (newData == NULL) {
                                ...
                                const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtMallocMex((uint32_T)newCapacity * sizeof(uint16_T));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
...
/* End of code generation (EROS_all_double_set_add_clipAny_limit5_emxutil.c) */
